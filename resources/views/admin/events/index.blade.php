...
<section class="p-6">
    <div class="flex mb-6">
        ...
        <div class="flex flex-col items-end justify-center w-1/2 text-right">
            <a href="{{ route('admin.events.create') }}" class="px-4 py-3 mb-6 bg-primary rounded font-semibold text-white text-xl">Agregar +</a>
    ...
    <div class="flex items-center my-4">
        ...
        <a href="{{ route('admin.events.slider') }}" class="ml-auto text-primary hover:underline">Editar</a>
    </div>
