<template>
    <form :action="url('admin/cursos/actualizar/'+data_cursos.id)" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-6 gap-4">
      <div class="md:col-span-4">  
        ...
        <!-- Título -->
        <div class="flex items-center mb-5">
          <label for="title" class="w-6/12">Nombre del curso</label>
          <input
            type="text"
            name="nombre"
            id="nombre"
            v-model="data_cursos.nombre"
        ...
        <div class="flex items-center mb-5">
          ...
          <textarea
            ...
            id="desciption_curso"
            v-model="data_cursos.descripcion_curso"
        ...
        <div class="flex items-center mb-5">
          ...
          <textarea
            ...
            name="descripcion"
            id="description"
            v-model="data_cursos.descipcion"
      ...
      <div class="md:col-span-2">
        ...
        <div class="flex items-center mb-5">
          ...
          <select name="clase" id="clase" v-model="data_cursos.clase" class="w-full px-2 py-2 focus:outline-none focus:shadow-outline border border-gray-400">
    ...
    <ModalSelectCategory
      ...
      :currentCategories="data_cursos.categories"
...
export default {
  ...
  setup(props) {
    ...
    const selectedCategories = ref(props.data_cursos.categories);
    const sellType = ref('');
